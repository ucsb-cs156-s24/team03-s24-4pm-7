...
public class RecommendationRequestWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_recommendationRequest() throws Exception {
    ...
    page.getByTestId("RecommendationRequestForm-dateRequested").pressSequentially("01010020250210PM");
    page.getByTestId("RecommendationRequestForm-dateNeeded").pressSequentially("01020020260210PM");
    ...
    page.getByTestId("RecommendationRequestForm-professorEmail").fill("professor1@ucsb.edu");
    page.getByTestId("RecommendationRequestForm-submit").click();

    assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-professorEmail"))
        .hasText("professor1@ucsb.edu");
