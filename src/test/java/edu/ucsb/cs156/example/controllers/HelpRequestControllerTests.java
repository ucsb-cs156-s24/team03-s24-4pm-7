...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_helprequests() throws Exception {
                ...
                HelpRequest helpRequest1 = HelpRequest.builder()
                                .requesterEmail("example_email@ucsb.edu")
                                .teamId("07")
                                .tableOrBreakoutRoom("table")
                                .requestTime(ldt1)
                                .explanation("a sample explanation for test 1")
                                .solved(true)
                                .build();
                ...
                HelpRequest helpRequest2 = HelpRequest.builder()
                                .requesterEmail("another_email@gmail.com")
                                .teamId("00")
                                .tableOrBreakoutRoom("breakoutRoom")
                                .requestTime(ldt2)
                                .explanation("another explanation for test 2")
                                .solved(false)
                                .build();
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/helprequest/post?requesterEmail=example_email@ucsb.edu&teamId=07&tableOrBreakoutRoom=table&requestTime=2022-01-03T00:00:00&explanation=explanation&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_helprequest() throws Exception {
                ...
                HelpRequest helpRequestEdited = HelpRequest.builder()
                                ...
                                .teamId("99")
                                .tableOrBreakoutRoom("tableAndbreakout")
                                .requestTime(ldt2)
        ...
        public void admin_cannot_edit_ucsbdate_that_does_not_exist() throws Exception {
                ...
                HelpRequest helpRequestEditedDate = HelpRequest.builder()
                                .requesterEmail("example_email@ucsb.edu")
                                .teamId("07")
                                .tableOrBreakoutRoom("table")
                                .requestTime(ldt1)
                ...
                String requestBody = mapper.writeValueAsString(helpRequestEditedDate);
