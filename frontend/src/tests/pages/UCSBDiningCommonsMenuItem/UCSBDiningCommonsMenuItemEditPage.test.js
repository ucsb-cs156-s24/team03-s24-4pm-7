...
describe("UCSBDiningCommonsMenuItemEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(diningCommonsCodeField).toHaveValue("code");
            expect(nameField).toHaveValue("name");
            expect(stationField).toHaveValue("station");
        ...
        test("Changes when you click Update", async () => {
            ...
            expect(submitButton).toBeInTheDocument();
            fireEvent.change(diningCommonsCodeField, { target: { value: 'code1' } })
            fireEvent.change(nameField, { target: { value: 'name1' } })
            fireEvent.change(stationField, { target: { value: "station1" } })

            fireEvent.click(submitButton);

            await waitFor(() => expect(mockToast).toBeCalled());
            expect(mockToast).toBeCalledWith("Menu Item Updated - id: 17 diningCommonsCode: code name: name station: station");
